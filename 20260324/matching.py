...
h2_resp_el_pt = ROOT.TH2F("h_resp_el_pt", "h_resp_el_pt", 8, 0, 400., 8, 0, 400.)
...
for i in range(t.GetEntries()):
  ...
  if delta_best_el < delta_max and irec_best_el >= 0:
    ...
    t_new_el.Fill()
    h2_resp_el_pt.Fill(genp4_el.Pt(), elPt[irec_best_el])
...
c_resp = ROOT.TCanvas('c_resp', 'Response matrix', 300, 300)
c_resp.cd()
norm_response(h2_resp_el_pt)
h2_resp_el_pt.Draw('colztext')
c_resp.SaveAs('response_el.pdf')
c_resp.SaveAs('response_el.png')
