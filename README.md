...
#### [Записи занять](https://cernbox.cern.ch/s/AGKt3cRI6t6PQip)
  ...
  - 05.05.2026
     - [Катерина] подивились коротке введення в гамма-спектроскопію та гамма-спектрометрію, методику досліджень ядерних реакцій. Розглянуто інструменти, що використовуються для ідентифікації піків у апаратурних гамма-спектрах та визначення каналів реакцій їх напрацювання. Також показано реалізацію коду для аналізу часової еволюції активності гамма-ліній у серіях вимірювань + розбиття загальної активності на складові на прикладі лінії 511 кеВ. 
     - [посилання на фрагменти коду для обробки даних і слайди](https://github.com/catisok/univ_hep.git)
